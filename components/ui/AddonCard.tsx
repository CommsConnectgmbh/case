...
export default function AddonCard({ id, name, priceBrutto, image, description }: AddonCardProps) {
  ...
  return (
    <div className="group rounded-2xl p-4 flex items-center gap-4 bg-white/[0.02] border border-white/[0.06] hover:bg-white/[0.04] hover:border-white/[0.1] transition-all duration-400">
      ...
      <div className="flex-1 min-w-0">
        ...
        <span className="text-primary font-bold text-sm">{formatPrice(priceBrutto)}</span>
      </div>
      <motion.button
