export const PRODUCTS = {
  standard: {
    ...
    description: 'Mobiles 5G-Koffersystem mit Teltonika RUTX50 Router (Dual-SIM, Dual-Band-WLAN, 5 × Gigabit-Ethernet), Teltonika RMS mit 10-Jahres-Lizenz, Poynting 5G-Panelantenne (A-PANL-0431) mit 4×4 MIMO und GNSS im Kofferdeckel, Cudy RE3000 Wi-Fi-6-Mesh-Repeater, 30 m Cat6-Netzwerkkabel, robuster PARAT-Systemkoffer, gefertigt von PARAT in Waldkirchen. Akkubetrieb möglich, Akku und Markenadapter nicht im Lieferumfang enthalten.',
    features: [
      'Teltonika RUTX50 5G-Router (Dual-SIM)',
      'Teltonika RMS 10-Year Management Service',
      'Dual-Band-WLAN & 5 × Gigabit-Ethernet',
      'Poynting 5G-Panelantenne im Kofferdeckel: 4×4 MIMO und GNSS',
...
export const ADDONS = {
  ...
  adapters: [
    ...
    { id: 'adapter-fein', name: 'Brennenstuhl Adapter – Fein', priceNetto: 16.80, image: '/images/fein.jpg', description: 'Adapter für Fein 18V Akkus. Akku nicht enthalten.' },
  ],
} as const;
