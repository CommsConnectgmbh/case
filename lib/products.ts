export const PRODUCTS = {
  standard: {
    ...
    description: 'Mobiles 5G-Koffersystem mit Teltonika RUTX50 Router (Dual-SIM, Dual-Band-WLAN, 5 × Gigabit-Ethernet), Teltonika RMS mit 10-Jahres-Lizenz, Poynting 5G-Panelantenne (A-PANL-0431) im Kofferdeckel, 30 m Cat6-Netzwerkkabel, robuster PARAT-Systemkoffer, gefertigt von PARAT in Waldkirchen. Akkubetrieb möglich, Akku und Markenadapter nicht im Lieferumfang enthalten.',
    features: [
